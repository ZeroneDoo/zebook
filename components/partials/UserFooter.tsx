import { IconBookmark, IconBooks, IconBrandFacebook, IconBrandInstagram, IconBrandTiktok, IconBrandX, IconBuildingMonument, IconCategory, IconHeadphones, IconInfoCircle, IconMail, IconNews, IconPencil, IconShield, IconSparkles, IconTrophy } from "@tabler/icons-react";
	...
	return (
		<footer className="bg-[#221508] p-6 sm:p-10 lg:p-13 lg:pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 text-[#F5EBD9]/45">
			<div className="flex flex-col justify-between">
				<div>
					...
					<p className="text-xs text-[#F5EBD9]/45 leading-relaxed max-w-55 mt-2.5">
						Your personal digital library. Discover, read, and collect books from authors around the world.
					</p>
				</div>
				<div className="flex gap-2.5 mt-5">
					{[IconBrandInstagram, IconBrandX, IconBrandFacebook, IconBrandTiktok].map((SocialIcon, idx) => (
						<div key={idx} className="w-8.5 h-8.5 rounded-full border border-[#D4C4AE]/20 flex items-center justify-center text-[#F5EBD9]/40 cursor-pointer transition-all hover:border-[#B8A080] hover:text-[#D4C4AE]">
							<SocialIcon size={16} />
						</div>
					))}
				</div>
			...
			<div>
				...
				<ul className="space-y-2.5 text-sm">
					<li><a href="#" className="flex items-center gap-2 hover:text-[#D4C4AE] transition-colors"><IconBooks size={14} /> My Library</a></li>
					<li><a href="#" className="flex items-center gap-2 hover:text-[#D4C4AE] transition-colors"><IconBookmark size={14} /> Reading List</a></li>
					<li><a href="#" className="flex items-center gap-2 hover:text-[#D4C4AE] transition-colors"><IconTrophy size={14} /> Membership</a></li>
					<li><a href="#" className="flex items-center gap-2 hover:text-[#D4C4AE] transition-colors"><IconBuildingMonument size={14} /> Settings</a></li>
				</ul>
			</div>
